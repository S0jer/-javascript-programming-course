...
function filterProducts(category, subcategory) {
    const filteredProducts = productList.filter((product) => product.category === category && product.subcategory === subcategory);
...
function addEventListeners() {
    ...
    if (menuZestawy)
        menuZestawy.addEventListener("click", () => filterProducts('Komputery', 'Zestawy'));
    if (menuLaptopy)
        menuLaptopy.addEventListener("click", () => filterProducts('Komputery', 'Laptopy'));
    if (menuMyszki)
        menuMyszki.addEventListener("click", () => filterProducts('Akcesoria', 'Myszki'));
    if (menuKlawiatury)
        menuKlawiatury.addEventListener("click", () => filterProducts('Akcesoria', 'Klawiatury'));
    if (menuSluchawki)
        menuSluchawki.addEventListener("click", () => filterProducts('Akcesoria', 'Sluchawki'));
    if (home)
        home.addEventListener("click", () => renderProducts(productList));
    ...
    if (demo) {
        ...
        if (demoMenuZestawy)
            demoMenuZestawy.addEventListener("click", () => filterProducts('Komputery', 'Zestawy'));
        if (demoMenuLaptopy)
            demoMenuLaptopy.addEventListener("click", () => filterProducts('Komputery', 'Laptopy'));
        if (demoMenuMyszki)
            demoMenuMyszki.addEventListener("click", () => filterProducts('Akcesoria', 'Myszki'));
        if (demoMenuKlawiatury)
            demoMenuKlawiatury.addEventListener("click", () => filterProducts('Akcesoria', 'Klawiatury'));
        if (demoMenuSluchawki)
            demoMenuSluchawki.addEventListener("click", () => filterProducts('Akcesoria', 'Sluchawki'));
        if (demoHome)
            demoHome.addEventListener("click", () => renderProducts(productList));
    }
}
