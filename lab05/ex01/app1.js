...
app.use(express.urlencoded({ extended: false })); // This middleware is used to parse the POST form data
    ...
    <html lang="en">
       ...
       <body>
          <main>
             ...
             <label for="name">Give your name for POST</label>
             <input name="name">
             <br>
             <input type="submit">
             <input type="reset">
             ...
             <form method="GET" action="/submit">
                <label for="name">Give your name for SUBMIT</label>
                <input name="name">
                <br>
                <input type="submit">
                <input type="reset">
